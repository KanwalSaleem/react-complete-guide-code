  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'reset-password/:resetToken', element: <SetNewPassword /> },
    ...
    // Dashboard Routes
    {
      ...
      children: [
        { element: <Navigate to="/dashboard/network/contacts" replace /> },
        { path: 'app', element: <GeneralApp /> },
        { path: 'ecommerce', element: <GeneralEcommerce /> },
        { path: 'analytics', element: <GeneralAnalytics /> },
        { path: 'banking', element: <GeneralBanking /> },
        { path: 'booking', element: <GeneralBooking /> },
        { path: 'network/contacts', element: <Contacts /> },

        {
          path: 'network',
          children: [
            { element: <Navigate to="/dashboard/network/companies" replace /> },
            { path: 'companiesprofile', element: <CompaniesProfile /> },
            {
              path: 'contacts',
              element: <Contacts />
            },
            ...
            { path: 'contactprofile', element: <ContactProfile /> },
            { path: 'preferred-contacts', element: <PreferredContacts /> },
            { path: 'preferred-clients', element: <PreferredClients /> },
...

        {
          path: 'project',
          children: [
            { element: <Navigate to="/dashboard/project/projects" replace /> },
            { path: 'createNewProjects', element: <CreacteNewProject /> },
        ...
        },
        {
          ...
          children: [
            ...
            { path: 'product/new', element: <CreacteNewProject /> },
...
// NETWORK
const CompaniesProfile = Loadable(lazy(() => import('../pages/dashboard/network/CompaniesProfile')));
const Contacts = Loadable(lazy(() => import('../pages/dashboard/network/Contacts')));
const CompaniesList = Loadable(lazy(() => import('../pages/dashboard/network/CompaniesList')));
const AllContacts = Loadable(lazy(() => import('../pages/dashboard/network/AllContacts')));
const Clients = Loadable(lazy(() => import('../pages/dashboard/network/Clients')));
const PreferredContacts = Loadable(lazy(() => import('../pages/dashboard/network/PreferredContacts')));
const PreferredClients = Loadable(lazy(() => import('../pages/dashboard/network/PreferredClients')));
const Companies = Loadable(lazy(() => import('../pages/dashboard/network/Companies')));
const EditCompany = Loadable(lazy(() => import('../pages/dashboard/network/EditCompany')));
const EditContact = Loadable(lazy(() => import('../pages/dashboard/network/EditContact')));
// IMPORT COMPONENTS

// PROJECT
const CreacteNewProject = Loadable(lazy(() => import('../pages/dashboard/projects/CreateNewProject')));
const ProjectList = Loadable(lazy(() => import('../pages/dashboard/projects/Projects')));
const ProjectProfile = Loadable(lazy(() => import('../pages/dashboard/projects/ProjectProfile')));
const EditProject = Loadable(lazy(() => import('../pages/dashboard/projects/EditProject')));
// Authentication
...
const ContactProfile = Loadable(lazy(() => import('../pages/dashboard/network/ContactProfile')));
