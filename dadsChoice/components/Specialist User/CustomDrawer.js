        ...
        <View style={styles.drawerContent}>
          <View style={styles.profileSection}>
            <Avatar.Image
              size={100}
              source={{
                uri: `https://orioninfosolutions.in/under-development/dadchoice/public/storage/uploads/specialist/img/${img}`,
              }}
              style={{marginRight: 10}}
            />
            <View style={styles.profileInfo}>
              <Text style={{fontSize: 20}}>{`${firstName} ${lastName}`}</Text>
              <Caption style={{fontSize: 16}}>{specialist}</Caption>
            </View>
          </View>
          <Drawer.Section>
            <View style={{paddingLeft: 20}}>
              ...
              <DrawerItem
                ...
                icon={() => (
                  <View style={{marginRight: -20}}>
                    <Icon color={Colors.primary} name="event" size={30} />
                  </View>
                )}
