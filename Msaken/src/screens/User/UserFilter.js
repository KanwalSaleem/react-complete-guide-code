...
const UserFilter = () => {
  ...
  const SelectedProperty = name => {
    if (selectedPropertyType.includes(name)) {
        ...
        <ScrollView keyboardShouldPersistTaps={'handled'}>
          <View style={[styles.component_view]}>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={SelectedProperty.bind(this, 'Homes')}
                style={[
                  {
                    flexDirection:
                      selectedLanguage === 'arabic' ? 'row-reverse' : 'row',
                  },
                  selectedPropertyType.includes('Homes')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPropertyType.includes('Apartments')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPropertyType.includes('Offices')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPropertyType.includes('Retail')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPropertyType.includes('Industry')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPropertyType.includes('Warehouse')
                    ? styles.Property_type_Buttons_Active
                    : styles.Property_type_Buttons,
                ]}>
                <Image
