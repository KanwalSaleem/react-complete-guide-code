        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <View style={styles.topBar}>
              <Text style={styles.topBarText}>Quiz Category</Text>
            ...
            <View style={styles.modalFileds}>
              <TouchableOpacity
                ...
                <Text style={styles.quizText}>Create Quiz</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                style={styles.createQuiz}>
                <Text style={styles.quizText}>Sample Papers</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
